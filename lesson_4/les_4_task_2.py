...
# Функция основана на теореме о распределении простых чисел, она утверждает, что функция
...
print(f'Число "{sieve_without_eratosthenes(user_number)}" - это {user_number}-е по счёту простое число')

print('Алгоритм 2 с использованием алгоритма «Решето Эратосфена»')
print(f'Число "{sieve_eratosthenes(user_number)}" - это {user_number}-е по счёту простое число')